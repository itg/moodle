...
define("COOKIE_VALUE_MAPP2", 'mapp1cron');
...
if ($do_set_cookie || $do_clear_cookie) {
    ...
    echo '<a href="manage_lb_cookie.php?set_cookie=1&cookie_value=' . COOKIE_VALUE_MAPP2 . '">mapp1cron</a> | ';
